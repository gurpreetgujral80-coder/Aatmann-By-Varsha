...
# --- NEW: robots.txt and sitemap.xml routes for SEO crawling ---
@app.route("/robots.txt")
def robots_txt():
    # Disallow admin pages so search engines won't index them
    content = (
        "User-agent: *\n"
        ...
        "Allow: /\n"
        "Sitemap: https://aatmannbyvarsha.pythonanywhere.com/sitemap.xml\n"
    )
...
def sitemap_xml():
    ...
    <urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
      <url>
        <loc>https://aatmannbyvarsha.pythonanywhere.com/</loc>
      </url>
      <url>
        <loc>https://aatmannbyvarsha.pythonanywhere.com/tarot</loc>
      </url>
      <url>
        <loc>https://aatmannbyvarsha.pythonanywhere.com/numerology</loc>
      </url>
      <url>
        <loc>https://aatmannbyvarsha.pythonanywhere.com/about </loc>
      </url>
    </urlset>
    """
